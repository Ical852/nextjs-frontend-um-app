...
const LoginPage: React.FC<RegisterPageProps> = (props) => {
    ...
    <div className="flex h-full w-full flex-col justify-center px-6 py-24 lg:px-8">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <p className="mt-5 text-center text-sm text-gray-500">
          ...
          <Link href="/login" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500"> Login here</Link>
        </p>
      </div>
    </div>
  );
